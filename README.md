...
This back-end application is designed to work in conjunction with the [Hello Rails Front-End](https://github.com/lRebornsl/hello-react-front-end) project. The back-end project provides a server API, and the front-end application makes requests to `http://localhost:3000/api/greeting` to fetch random greetings. Ensure that the back-end server is running before using this application.
...
```sh
git clone git@github.com:lRebornsl/hello-rails-back-end.git
...
The API will be accessible at `http://localhost:3000/api/greeting`.
...
Find a bug or have a feature request? [Open a new issue](https://github.com/lRebornsl/hello-rails-back-end/issues) here on GitHub.

<p align="right">(<a href="#readme-top">back to top</a>)</p>

## 🤝 Contributing <a name="contributing"></a>

Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/lRebornsl/hello-rails-back-end/issues).
